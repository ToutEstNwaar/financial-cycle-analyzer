...
def _get_default_settings():
    ...
    # These _base keys are what calculate_core_cycle_components expects
...
st.sidebar.slider(
    ...
    min_value=20,  # Min value can be adjusted
    max_value=500, # Max value can be adjusted
    step=10,
    key="WindowSizePast_base",
    help="Defines the base number of bars for the past wave. Will be at least 2 * MaxPer."
)
st.sidebar.slider(
    ...
    help="Defines the base number of bars for the future wave. Will be at least 2 * MaxPer."
)
